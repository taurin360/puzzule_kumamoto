...
(() => {
  class PuzzleRenderer {
    ...
    renderGameClear() {
      ...
      this.ctx.fillText('みんな若いね', 50, 50);
      this.gameOverSound = new Audio("audio/young.mp3");
    ...
    renderTile(n, col, row) {
      if (n === this.puzzle.getBlankIndex()) {
        ...
        this.ctx.fillRect(col * this.TILE_SIZE,
                          row * this.TILE_SIZE,
                          this.TILE_SIZE,
                          this.TILE_SIZE
                         );
